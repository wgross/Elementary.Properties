...
namespace Elementary.Properties.Test.Setters
{
    public class ReflectionSetterFactoryTest
    {
        ...
        public void Setter_writes_public_property_value()
        {
            ...
            var setter = ReflectionSetterFactory.Of<Data, int>(o => o.PublicIntegerPublicSetter);
        ...
        public void Setter_writes_protected_property_value()
        {
            ...
            var data = new Data { PublicIntegerPublicSetter = 0 };
            var setter = ReflectionSetterFactory.Of<Data, int>(o => o.PublicIntegerProtectedSetter);
        ...
        public void Setter_writes_private_property_value()
        {
            ...
            var data = new Data { PublicIntegerPublicSetter = 0 };
            var setter = ReflectionSetterFactory.Of<Data, int>(o => o.PublicIntegerPrivateSetter);
